                    ...
                    <div id="ranking">
                        ...
                        <div class="ranking__content tier-view">
                            <table class="m-table">
                                ...
                                <tbody>
                                   	<%
                                   		sql = "select distinct r.rank, o.org_url, o.avatar_url, r.org_name, r.total_score "
    										+ "from organization_ranks r, organization o "
    										+ "where r.rank <= 50 and o.org_rank_id = r.org_rank_id "
    										+ "order by r.rank";
